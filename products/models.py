...
class Product(models.Model):
    ...
    category = models.ForeignKey('accounts.ProductCategory', models.DO_NOTHING, blank=True, null=True)
    ...
    sub_category = models.ForeignKey('accounts.ProductSubCategory', models.DO_NOTHING, blank=True, null=True)
